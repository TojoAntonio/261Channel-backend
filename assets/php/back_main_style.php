...
* { margin:0; padding:0; }
body { font: 70%/1.7em "Lucida Grande", "Lucida Sans Unicode", verdana, geneva, sans-serif; color:#555; background: #fff url(<?php echo $racine; ?>assets/images/back/headerbg.gif) repeat-x; }
table{ font: 100%/1.7em "Lucida Grande", "Lucida Sans Unicode", verdana, geneva, sans-serif; color:#555;}
/* general styling */
...
/* content */
.wrap { padding:20px; width:860px; margin:0 auto; margin-left:350px; }
...
#nav li a.current { background: url(<?php echo $racine; ?>assets/images/back/barbg.gif) no-repeat bottom center; color:#fff; }	
...
#left { float: left; width: 570px; margin: 0 0 20px 0; }
	#left h2 { float: left; font: 2.1em "Trebuchet MS", Arial; background: url(<?php echo $racine; ?>assets/images/back/h2bg.gif) repeat-x bottom; color:#121212; letter-spacing:-1px; margin: 0px 0 20px 0; clear:left; }
...
#right {	width:230px; float:right; margin: 0 0 20px 0; }
	#right h2 { color:#fff; margin: 0 0 5px 0; font: bold 1.2em "Trebuchet MS", Arial; background: #fff url(<?php echo $racine; ?>assets/images/back/sideh2bg.gif) repeat-x; padding: 4px 10px; border-bottom: 2px solid #000; }
