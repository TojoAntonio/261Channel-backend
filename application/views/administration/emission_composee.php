    ...
    <div class="wrap" style="margin-top:5%;min-height: 300px;">
        <div id="left">
            ...
            <div id="upload">
                <br/>
                <?php
                echo form_open_multipart('administration/emission/composee');
                ...
                <?php
                    ...
                    echo '<th style="max-width:10px;"><input type="checkbox" onclick="selectAll(this)" /></th>';
                    echo '<th>Nom émission</th>';
                    echo '<th>Durée</th></tr>';
                ...
                <?php
                echo '<br/><br/><input type="submit" name="valid" value="Valider" style="width:100px;height:25px;" /> ';
